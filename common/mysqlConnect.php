<?php
    ...
    // データベース接続の設定
            ...
            //$user = "whisper_e";       // 接続するユーザー名を指定します。         例：root、dbuser(自作したユーザー) etc..
            //$password = "c2AGryF3";    // 接続するユーザーのパスワードを指定します。
            //$database = "whisper_e";   // 接続するデーターベース名を指定します。　　　例：studb、whisperdb etc..
